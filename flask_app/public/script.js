...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchListings() {
        ...
        try {
            const response = await fetch(`/fetch_listings?complex_no=${complexNo}&trade_type=${tradeType}`);
            if (!response.ok) {
    ...
    function downloadExcel() {
        ...
        const downloadUrl = `/download_excel?complex_no=${complexNo}&trade_type=${tradeType}`;
